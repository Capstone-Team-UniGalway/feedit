...
class TestCreateReviewView:
    ...
    def setup_method(self):
        ...
        self.url = reverse(
            "reviews:create_review", kwargs={"company_id": self.company.id}
        )
    ...
    def test_successful_authenticated_review_creation(self):
        ...
        # In test environment, may redirect due to authentication req or show form
...
class TestReviewReplyCreateView:
    ...
    def setup_method(self):
        ...
        self.url = reverse(
            "reviews:create_review_reply", kwargs={"review_id": self.review.id}
        )
        ...
        if response.status_code == 302:
            ...
            if "/account/auth" not in response.url:
                ...
                expected_url = reverse(
                    "companies:detail", kwargs={"pk": self.company.pk}
                )
