...
def render_mentions(text):
    ...
    def replace_mention(match):
        ...
        return format_html('<a href="{}" class="mention">@{}</a>', profile_url, username)
...
def mention_input(name, id=None, value=None, css_class='', placeholder=None, required=False):
    """
    Renders a textarea with @mention support.
    
    Usage:
    {% mention_input name="content" id="thread_content" value=form.content.value css_class="h-32" %}
    """
    return {
        'name': name,
        'id': id,
