...
def activate_user(user):
    """Helper function to ensure user is properly activated for tests"""
    user.is_active = True
...
class TestJoinRequestFileDownloadView:
    def test_join_request_file_requires_login(self, client):
        ...
        url = reverse('secure_files:download_join_request_file', kwargs={
    ...
    def test_employee_can_access_own_join_request_file(self, client):
        # Create an employee
        employee = activate_user(UserFactory(type=User.UserType.EMPLOYEE))
    ...
    def test_employee_cannot_access_others_join_request_file(self, client):
        ...
        employee1 = activate_user(UserFactory(type=User.UserType.EMPLOYEE))
        employee2 = activate_user(UserFactory(type=User.UserType.EMPLOYEE))
    ...
    def test_employer_can_access_join_request_file_for_their_company(self, client):
        ...
        # Create an employer
        employer = activate_user(UserFactory(type=User.UserType.EMPLOYER))
    ...
    def test_employer_cannot_access_join_request_file_for_other_company(self, client):
        ...
        employer1 = activate_user(UserFactory(type=User.UserType.EMPLOYER))
        employer2 = activate_user(UserFactory(type=User.UserType.EMPLOYER))

        # Create two companies
        company1 = CompanyFactory(employer=employer1)
        company2 = CompanyFactory(employer=employer2)
    ...
    def test_admin_can_access_any_join_request_file(self, client):
        ...
        admin = activate_user(UserFactory(is_superuser=True))
...
class TestClaimRequestFileDownloadView:
    def test_claim_request_file_requires_login(self, client):
        ...
        url = reverse('secure_files:download_claim_request_file', kwargs={
