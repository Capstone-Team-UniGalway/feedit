...
class TestCustomLoginForm:
    ...
    def test_form_initialization(self):
        ...
        assert (
            "input input-bordered w-full" in form.fields["login"].widget.attrs["class"]
        )
        ...
        assert (
            ...
            in form.fields["password"].widget.attrs["class"]
        )
...
class TestCustomSignupForm:
    ...
    def test_field_styling(self):
        ...
        assert (
            "input input-bordered w-full"
            in form.fields["first_name"].widget.attrs["class"]
        )
        assert (
            "input input-bordered w-full"
            in form.fields["last_name"].widget.attrs["class"]
        )
        assert (
            "select select-bordered w-full" in form.fields["type"].widget.attrs["class"]
        )
        assert (
            "input input-bordered w-full" in form.fields["email"].widget.attrs["class"]
        )
        assert (
            "input input-bordered w-full"
            in form.fields["password1"].widget.attrs["class"]
        )
        assert (
            "input input-bordered w-full"
            in form.fields["password2"].widget.attrs["class"]
        )
...
class TestUserProfileForm:
    ...
    def test_form_initialization(self):
        ...
        assert form.fields["bio"].required is True
    ...
    def test_field_styling(self):
        ...
        assert (
            "input input-bordered w-full"
            in form.fields["job_title"].widget.attrs["class"]
        )
        assert (
            "textarea textarea-bordered w-full"
            in form.fields["bio"].widget.attrs["class"]
        )
        assert (
            "select select-bordered w-full"
            in form.fields["privacy"].widget.attrs["class"]
        )
    ...
    def test_valid_profile_form(self):
        ...
        form_data = {
            ...
            "bio": (
                "This is a comprehensive bio that meets the minimum length "
                "requirement for the form validation."
            ),
            "privacy": "public",
        }
