...
class TestEmailCommand:
    ...
    def test_command_default_arguments(self):
        ...
        with patch('accounts.management.commands.test_email.send_mail') as mock_send_mail:
            ...
            assert kwargs['recipient_list'] == ['geraghtyglenn@gmail.com']  # default recipient
            assert kwargs['fail_silently'] == False
    ...
    def test_command_output_formatting(self):
        ...
        with patch('accounts.management.commands.test_email.send_mail') as mock_send_mail:
            ...
            assert 'Sending test email from test@feedit.online to recipient@example.com...' in output
            assert 'Test email sent successfully!' in output
    ...
    def test_command_integration_with_django_settings(self):
        ...
        with override_settings(
            ...
            with patch('accounts.management.commands.test_email.send_mail') as mock_send_mail:
                ...
                mock_send_mail.assert_called_once()
                args, kwargs = mock_send_mail.call_args
                assert kwargs['from_email'] == 'console@feedit.online'  # from_email from settings
