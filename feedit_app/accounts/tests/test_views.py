...
from accounts.views import (
    ...
    ProfileView, PublicProfileView, EditProfileView, CloseAccountView,
...
class TestPublicProfileView:
    ...
    def test_view_public_profile(self):
        ...
        target_user = UserFactory(privacy='public')
        viewer = FullyActivatedUserFactory()
    ...
    def test_view_private_profile_redirects(self):
        """Test viewing a private profile redirects with warning."""
        target_user = UserFactory(privacy='private')
        viewer = FullyActivatedUserFactory()
    ...
    def test_view_own_profile(self):
        """Test viewing own profile through public profile view."""
        user = FullyActivatedUserFactory()

        self.client.force_login(user)

        response = self.client.get(reverse('account_public_profile', kwargs={'pk': user.pk}))
