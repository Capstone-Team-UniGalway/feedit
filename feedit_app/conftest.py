...
def test_settings():
    ...
    # Mock the FullyActivatedUserMixin to
    # allow access for authenticated users during tests
    ...
    # Add UserType class to AnonymousUser to prevent
    # AttributeError when accessing user.UserType.EMPLOYEE
    ...
    try:
        with (
            patch.object(FullyActivatedUserMixin, "test_func", mock_test_func),
