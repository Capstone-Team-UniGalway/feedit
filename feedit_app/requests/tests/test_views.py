...
class TestCreateRequestView:
    ...
    def setup_method(self):
        ...
        self.url = reverse('requests:create_with_id', kwargs={'company_id': self.company.id})
    ...
    def test_get_invalid_company_id(self):
        ...
        invalid_url = reverse('requests:create_with_id', kwargs={'company_id': 99999})
...
class TestCompanyRequestListView:
    ...
    def setup_method(self):
        self.client = Client()
        self.company = CompanyFactory()
        self.url = reverse('requests:company', kwargs={'company_id': self.company.id})
    ...
    def test_invalid_company_id(self):
        ...
        invalid_url = reverse('requests:company', kwargs={'company_id': 99999})
        response = self.client.get(invalid_url)
